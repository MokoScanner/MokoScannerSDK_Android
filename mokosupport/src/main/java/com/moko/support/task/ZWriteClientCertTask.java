...
public class ZWriteClientCertTask extends OrderTask {
    ...
    public ZWriteClientCertTask(MokoOrderTaskCallback callback, byte[] fileBytes) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_CLIENTCERT, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
