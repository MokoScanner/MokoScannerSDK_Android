...
public class ZWriteStaNameTask extends OrderTask {
    ...
    public ZWriteStaNameTask(MokoOrderTaskCallback callback, String satName) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_STA_NAME, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = satName.getBytes();
