...
public class ZWriteDeviceIdTask extends OrderTask {
    ...
    public ZWriteDeviceIdTask(MokoOrderTaskCallback callback, String deviceId) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_DEVICE_ID, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = deviceId.getBytes();
