...
public class ZWritePasswordTask extends OrderTask {
    ...
    public ZWritePasswordTask(MokoOrderTaskCallback callback, String password) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_PASSWORD, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
