...
public class ZWriteClientIdSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteClientIdSumTask(MokoOrderTaskCallback callback, String clientId) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_CLIENT_ID_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
