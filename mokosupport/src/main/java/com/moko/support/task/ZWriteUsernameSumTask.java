...
public class ZWriteUsernameSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteUsernameSumTask(MokoOrderTaskCallback callback, String username) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_USERNAME_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
