...
public class ZWriteStaNameSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteStaNameSumTask(MokoOrderTaskCallback callback, String satName) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_STA_NAME_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        byte[] dataBytes = satName.getBytes();
