...
public class ZWriteStaPasswordTask extends OrderTask {
    ...
    public ZWriteStaPasswordTask(MokoOrderTaskCallback callback, String staPassword) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_STA_PASSWORD, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = staPassword.getBytes();
