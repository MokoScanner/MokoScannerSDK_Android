...
public class ZWriteStaPasswordSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteStaPasswordSumTask(MokoOrderTaskCallback callback, String staPassword) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_STA_PASSWORD_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        byte[] dataBytes = staPassword.getBytes();
