...
public class ZWritePasswordSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWritePasswordSumTask(MokoOrderTaskCallback callback, String password) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_PASSWORD_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
