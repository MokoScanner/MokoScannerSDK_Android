...
public class ZWritePublishSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWritePublishSumTask(MokoOrderTaskCallback callback, String publishTopic) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_PUBLISH_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        byte[] dataBytes = publishTopic.getBytes();
