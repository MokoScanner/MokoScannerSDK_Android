...
public class ZWriteSubscribeTask extends OrderTask {
    ...
    public ZWriteSubscribeTask(MokoOrderTaskCallback callback, String subscribeTopic) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_SUBSCRIBE, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = subscribeTopic.getBytes();
