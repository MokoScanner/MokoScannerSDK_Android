...
public class ZWriteDeviceIdSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteDeviceIdSumTask(MokoOrderTaskCallback callback, String deviceId) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_DEVICE_ID_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
