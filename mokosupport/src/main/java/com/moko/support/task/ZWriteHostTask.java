...
public class ZWriteHostTask extends OrderTask {
    ...
    public ZWriteHostTask(MokoOrderTaskCallback callback, String host) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_HOST, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = host.getBytes();
