...
public class ZWriteUsernameTask extends OrderTask {
    ...
    public ZWriteUsernameTask(MokoOrderTaskCallback callback, String username) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_USERNAME, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = username.getBytes();
