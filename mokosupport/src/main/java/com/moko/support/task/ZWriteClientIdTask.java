...
public class ZWriteClientIdTask extends OrderTask {
    ...
    public ZWriteClientIdTask(MokoOrderTaskCallback callback, String clientId) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_CLIENT_ID, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        dataBytes = clientId.getBytes();
