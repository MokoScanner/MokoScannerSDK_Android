...
public class ZWriteClientPrivateTask extends OrderTask {
    ...
    public ZWriteClientPrivateTask(MokoOrderTaskCallback callback, byte[] fileBytes) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_CLIENTPRIVATE, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
