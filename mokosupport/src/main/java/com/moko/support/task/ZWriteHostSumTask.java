...
public class ZWriteHostSumTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 5;

    private byte[] orderData;

    public ZWriteHostSumTask(MokoOrderTaskCallback callback, String host) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_HOST_PACKAGE_SUM, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
