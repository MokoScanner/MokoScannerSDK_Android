...
public class ZWriteCATask extends OrderTask {
    ...
    public ZWriteCATask(MokoOrderTaskCallback callback, byte[] fileBytes) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_CA, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
